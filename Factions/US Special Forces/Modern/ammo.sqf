...
switch (_loadout) do {
	default {
		[ player, "rhs_mag_20Rnd_SCAR_762x51_m61_ap_bk", 5 ] call pxg_armory_fnc_addToVest;
		[ player, "rhs_mag_20Rnd_SCAR_762x51_m62_tracer_bk", 5 ] call pxg_armory_fnc_addToBackpack;
	};
	case "sqd_ar": {
	...
	case "rcn_dmr": {
		[ player, "rhsusf_20Rnd_762x51_SR25_m993_Mag", 6 ] call pxg_armory_fnc_addToVest;
		[ player, "rhsusf_20Rnd_762x51_SR25_m993_Mag", 8 ] call pxg_armory_fnc_addToBackpack;
	};
	case "sup_mmg_g": {
	...
	case "sup_mat_l": {
		[ player, "rhs_mag_20Rnd_SCAR_762x51_m61_ap_bk", 5 ] call pxg_armory_fnc_addToVest;
		[ player, "rhs_mag_20Rnd_SCAR_762x51_m62_tracer_bk", 1 ] call pxg_armory_fnc_addToBackpack;
	};
	case "pil": {};
};
...
switch (_loadout) do {
	default {
		[ player, "rhsusf_mag_17Rnd_9x19_JHP", 3 ] call pxg_armory_fnc_addToUniform;
	};
	case "pil";
	case "sqd_hgre": {
		[ player, "rhsusf_mag_17Rnd_9x19_JHP", 5 ] call pxg_armory_fnc_addToVest;
	};
};
...
switch (_loadout) do {
	...
	case "sup_mat_l": {
		...
		[ player, "rhs_mag_smaw_SR", 2 ] call pxg_armory_fnc_addToBackpack;
	};
	case "sup_aa_l": {
