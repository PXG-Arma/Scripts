...
_avialableLoadouts = 
	[
		...
		[["plt", "logi", "plt_med", "tacp"], ["sqd_ld", "sqd_med", "sqd_eng", "sqd_lat", "sqd_brc", "sqd_gre", "sqd_ar", "sqd_aar"], ["sf_ld", "sf_med", "sf_dmr", "sf_eng"], ["rcn_ld", "rcn_sni", "rcn_drone"], ["sup_mmg_l", "sup_mmg_g"], ["sup_hmg_l", "sup_hmg_g"], ["sup_mat_l", "sup_mat_g"], ["sup_hat_l", "sup_hat_g"], ["sup_aa_l", "sup_aa_g"], ["sup_mor_l", "sup_mor_g"], ["ar_ld", "ar_c"], ["r_pil","f_pil"]]
	];
