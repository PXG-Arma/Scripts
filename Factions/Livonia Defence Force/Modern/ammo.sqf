...
switch (_loadout) do {
	...
	case "rcn_amr": {
		[ player, "rhsusf_mag_10Rnd_STD_50BMG_M33", 4 ] call pxg_armory_fnc_addToBackpack;
		[ player, "rhsusf_mag_10Rnd_STD_50BMG_mk211", 2 ] call pxg_armory_fnc_addToBackpack;
		[ player, "rhsusf_mag_10Rnd_STD_50BMG_mk211", 2 ] call pxg_armory_fnc_addToVest;
	};
	case "sup_mmg_g": {
	...
	case "ar_c";
	case "pil": {
		[ player, "30Rnd_9x21_Mag_SMG_02", 4 ] call pxg_armory_fnc_addToVest;
	};
};
...
switch (_loadout) do {
	default {
		[ player, "rhssaf_mag_15Rnd_9x19_FMJ", 4 ] call pxg_armory_fnc_addToBackpack;
	};
	case "rcn_amr": {
		[ player, "rhssaf_mag_15Rnd_9x19_FMJ", 4 ] call pxg_armory_fnc_addToUniform;
	};
	case "sup_hat_l";
	case "sup_hat_g";
	case "sqd_eng";
