...
switch (_loadout) do {
	...
	case "rcn_dmr": {
		for "_i" from 1 to 6 do { player addItemToBackpack "rhsusf_20Rnd_762x51_SR25_m62_Mag"};
		for "_i" from 1 to 6 do { player addItemToBackpack "rhsusf_20Rnd_762x51_SR25_m993_Mag"};
	};
	case "pil": {
		for "_i" from 1 to 4 do { player addItemToBackpack "rhs_mag_30Rnd_556x45_M855A1_Stanag"};
	};
	case "sqd_brc": {
		for "_i" from 1 to 15 do { player addItemToBackpack "rhsusf_8Rnd_Slug"};
		for "_i" from 1 to 15 do { player addItemToBackpack "rhsusf_8Rnd_00Buck"};
	};
};

// add secondary ammo
switch (_loadout) do {
	default {for "_i" from 1 to 2 do { player addItemToUniform "rhsusf_mag_17Rnd_9x19_JHP"};};
	case "sqd_eng";
	case "rcn_spe": {};
};
