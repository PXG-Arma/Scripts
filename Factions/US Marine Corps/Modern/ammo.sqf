...
switch (_loadout) do {
	...
	case "rcn_dmr": {
		for "_i" from 1 to 4 do { player addItemToVest "rhsusf_5Rnd_762x51_AICS_m993_Mag"};
		for "_i" from 1 to 4 do { player addItemToBackpack "rhsusf_5Rnd_762x51_AICS_m62_Mag"};
	};
	case "sup_mmg_g": {
	...
	case "rcn_drone": {
		...
		for "_i" from 1 to 2 do { player addItemToVest "rhs_mag_30Rnd_556x45_M855A1_PMAG_Tracer_Red"};
...
switch (_loadout) do {
	...
	case "sqd_brc";
	case "rcn_dmr": {
		for "_i" from 1 to 4 do { player addItemToBackpack "rhsusf_mag_15Rnd_9x19_FMJ"};
	};
};
