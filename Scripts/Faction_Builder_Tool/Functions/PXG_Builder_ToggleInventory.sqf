/*
    PXG_Builder_ToggleInventory.sqf
    -------------------------------
...
private _isCollapsed = _display getVariable ["PXG_Inventory_Collapsed", false];
...
if (_isCollapsed) then {
	...
	_display setVariable ["PXG_Inventory_Collapsed", false];
} else {
	// COLLAPSE IT
	...
	_display setVariable ["PXG_Inventory_Collapsed", true];
};
